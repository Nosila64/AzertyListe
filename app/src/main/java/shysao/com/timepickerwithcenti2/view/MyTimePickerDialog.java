...
public class MyTimePickerDialog extends AlertDialog implements DialogInterface.OnClickListener,
    ...
    public interface OnTimeSetListener {
         ...
         */
        void onTimeSet(TimePicker view, int hourOfDay, int minute, int seconds, TextView textView);
    }
    ...
    public MyTimePickerDialog(Context context,
                              ...
                              int minute, int seconds, int centi, boolean is24HourView, TextView textView) {

        this(context, 0,
                callBack, minute, seconds, centi, is24HourView, textView);
    }
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (mCallback != null) {
            ...
            mCallback.onTimeSet(mTimePicker,
                    mTimePicker.getCurrentMinute(), mTimePicker.getCurrentSeconds(), mTimePicker.getCurrentCenti(), mInitialTV);
        }
    }
